            ...
            <div className={` ${animation}`}>
                {
                    List.map((item) => {
                        return (
                            ...
                            <div className={`bg-slate-200 p-5`} key={item.id} style={{ backgroundImage: `url('${item.bg_image}')`, backgroundRepeat: 'no-repeat', backgroundSize: "cover", height: '100svh', width: "100swh" }}>
